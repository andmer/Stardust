...
ObjectTemplates:addTemplate(object_tangible_component_weapon_reinforcement_core_advanced, "object/tangible/component/weapon/reinforcement_core_advanced.iff")
