...
includeFile("dungeon/death_watch_bunker/black_sun_guard_themepark.lua")
includeFile("dungeon/death_watch_bunker/black_sun_henchman_themepark.lua")
includeFile("dungeon/death_watch_bunker/black_sun_assassin_themepark.lua")
