...
function GeonosianLabScreenPlay:spawnMobiles()
	...
	-->>failed_experiment_62 Mini-Boss--<
	spawnMobile("yavin4", "failed_experiment_62",math.random(900, 1200),-66.5,-34,-282,0,1627812) -- Randomized respawn between 15mins to 20mins. Annoying fight with not-so-hot loot.
	-->>failed_experiment_62 Mini-Boss--<
	...
	-->>Failed Nightsister Experiment Mini-Boss<<<
	spawnMobile("yavin4", "failed_ns_clone",math.random(900, 1200), -134.117, -34, -182.739, -179, 1627815) -- Randomized respawn between 15mins to 20mins.
	-->>Failed Nightsister Experiment Mini-Boss<<<
	...
	spawnMobile("yavin4", "enhanced_rancor",1800, -149.346, -34.0142, -369.433, 52, 1627818) -- 30mins Respawn, meant to be a "Gate Keeper" for addtional content in GeoCave.
	-->>Enhanced Rancor Mini-Boss<<<
