...
function BilbousaCityScreenPlay:spawnMobiles()
  ...
  -- Bounty Hunter's Guild Interior
    ...
    self:setMoodString(pNpc, "happy")
    pNpc = spawnMobile("hutta", "hutt_enforcer",400,2.84,-0.894992,-6.3,16.0005,390000021)
    self:setMoodString(pNpc, "npc_imperial")
    pNpc = spawnMobile("hutta", "hutt_enforcer",400,3.62,-0.894992,-6.78,360.011,390000021)
    self:setMoodString(pNpc, "npc_accusing")
